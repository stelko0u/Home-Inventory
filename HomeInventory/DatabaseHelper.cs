...
//    {
//        private static string dbPath = @"D:\TU-VARNA\VIsemester\tsp_project\HomeInventory\storage.db";
...
namespace TSPProject
{
    class DatabaseHelper
    {
        ...
        public void AddProduct(string name, int categoryId, decimal price, int quantity)
        {
            ...
            {
                // Log or display error details for troubleshooting
                Console.WriteLine($"Error adding product: {ex.Message}");
                throw; // Re-throw exception so caller can handle it as well
            }
        }
